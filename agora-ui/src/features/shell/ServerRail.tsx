...
export function ServerRail() {
  ...
  return (
    <div className="w-[72px] bg-bg flex flex-col items-center py-3 gap-2 overflow-y-auto shrink-0">
      ...
      <button className="w-12 h-12 rounded-2xl bg-surface text-online flex items-center justify-center text-2xl font-light hover:rounded-xl hover:bg-online hover:text-white transition-all">
        +
      </button>
    </div>
  );
